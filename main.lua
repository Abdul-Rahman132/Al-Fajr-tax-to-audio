...
-- ========== EMOTIONS LIST (PROFESSIONAL ORDER - 40 ITEMS) ==========
local EMOTIONS = {
    -- Neutral (default)
    "Neutral",
    -- Basic emotions
    "Happy", "Sad", "Angry", "Excited", "Fearful",
    -- Professional / News / Formal
    "News Anchor", "Narrator", "Formal", "Casual",
    -- Positive / Warm / Friendly
    "Friendly", "Cheerful", "Hopeful", "Playful", "Romantic", "Loving", "Gentle", "Humble", "Innocent", "Calm", "Confident", "Proud", "Strong", "Bold", "Passionate",
    -- Negative / Intense / Gloomy
    "Gloomy", "Desperate", "Shy", "Bored", "Surprised", "Sarcastic",
    -- Performance / Storytelling
    "Storytelling", "Dramatic", "Energetic", "Funny", "Mysterious", "Serious", "Whisper", "Fast", "Slow"
}
...
-- ========== SINGLE VOICE WITH EXTENDED EMOTIONS (40) ==========
function generateSingleAudio(text, voice, apikey, model, generateBtn, playBtn, resultLayout)
    ...
    -- Emotion mapping for all 40 emotions
    local emotionPrefix = ""
    if selectedEmotion ~= "Neutral" then
        local emotionMap = {
            ...
            ["Formal"] = "Speak in a formal, official tone: ",
            ["Casual"] = "Speak in a casual, informal, relaxed tone: ",
            ["Friendly"] = "Speak in a warm, friendly tone: ",
            ["Cheerful"] = "Speak cheerfully, optimistically: ",
            ["Hopeful"] = "Speak hopefully, optimistically: ",
            ["Playful"] = "Speak in a playful, teasing tone: ",
            ["Romantic"] = "Speak in a romantic, loving, soft tone: ",
            ["Loving"] = "Speak in a loving, affectionate tone: ",
            ["Gentle"] = "Speak gently, softly, kindly: ",
            ["Humble"] = "Speak humbly, modestly: ",
            ["Innocent"] = "Speak innocently, naively: ",
            ["Calm"] = "Speak in a very calm, peaceful manner: ",
            ["Confident"] = "Speak confidently, assertively: ",
            ["Proud"] = "Speak proudly, boastfully: ",
            ["Strong"] = "Speak with strong, powerful voice: ",
            ["Bold"] = "Speak boldly, fearlessly: ",
            ["Passionate"] = "Speak passionately, intensely: ",
            ["Gloomy"] = "Speak in a gloomy, depressed manner: ",
            ["Desperate"] = "Speak desperately, urgently: ",
            ["Shy"] = "Speak shyly, hesitantly: ",
            ["Bored"] = "Speak in a bored, uninterested tone: ",
            ["Surprised"] = "Speak with surprise, astonishment: ",
            ["Sarcastic"] = "Speak sarcastically, ironically: ",
            ["Storytelling"] = "Speak like a captivating storyteller: ",
            ["Dramatic"] = "Speak with dramatic flair and expression: ",
            ["Energetic"] = "Speak with high energy and enthusiasm: ",
            ["Funny"] = "Speak in a funny, comedic, light-hearted tone: ",
            ["Mysterious"] = "Speak in a mysterious, intriguing tone: ",
            ["Serious"] = "Speak in a serious, grave tone: ",
            ["Whisper"] = "Speak in a soft whisper: ",
            ["Fast"] = "Speak quickly, rapidly: ",
            ["Slow"] = "Speak slowly with pauses: "
        }
        ...
        run = function()
            if not completed then
                ...
                if attempt < maxRetries then
                    ...
                    delay(2000, function() generateSingingChunkWithRetry(text, voice, apikey, model, maxRetries, callback, attempt+1) end)
                else
...
• Select an emotion from 40+ styles (Happy, Sad, 
  Romantic, Funny, Storytelling, etc.)
...
• Choose a music style (Romantic Guitar, Sad Piano, etc.)
• Either write your own lyrics OR enter a theme/situation
• AI creates a male+female singing duet with background
...
■ EXIT Button
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
• Closes extension and stops any generation
...
click the "Send Feedback" button below.
]]
